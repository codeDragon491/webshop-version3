...
try {
            ...
            require 'connect.php';
            // create a query to get all column records by price high to low
            $query = $conn->prepare("SELECT productCode, productName, buyPrice, quantityInStock FROM products ORDER BY buyPrice DESC");
            // run the query
